...
default_settings(Config) ->
    ...
    <<"default">> = proplists:get_value(<<"environment">>, DataPart),
    <<"error">> = proplists:get_value(<<"level">>, DataPart),
    <<"beam">> = proplists:get_value(<<"platform">>, DataPart),
    <<"erlang">> = proplists:get_value(<<"language">>, DataPart),
...
bigger_crash(Config) ->
    ...
    [Frame1, _, _, _, _] = proplists:get_value(<<"frames">>, Trace),
